                                ...
                                <tbody>
                                    @foreach ($pemesanans as $pemesanan)
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                <form action="{{ route('delete', $pemesanan->id) }}" method="POST" onsubmit="return confirmDelete('{{ $pemesanan->id }}', '{{ $pemesanan->nama_design }}');">
                                                    @csrf
                                                    @method('DELETE')
...
<script>
    function confirmDelete(id, namaDesign) {
        return confirm('Are you sure you want to delete the order with ID: ' + id + ' and Design: ' + namaDesign + '?');
    }
</script>
@endsection
